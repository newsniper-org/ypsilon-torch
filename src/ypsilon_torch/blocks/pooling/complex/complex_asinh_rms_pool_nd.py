...
class ComplexAsinhRMSPoolND(ComplexNDPoolBase):
    r"""Complex N-dimensional pooling: SinhRMSArsinh on magnitude + circular mean phase.

    Applies :func:`sinh_rms_arsinh` to the **magnitude** of each complex
